$(document).ready(function () {
	$(document.body).on('submit', '.js-confirm', function () {
		var $del = $(this)
       	var text = $del.data('confirm') ? $del.data('confirm') : 'You are sure to perform this action?'
       	var c = confirm(text);
       	return c;
   	});
   	...
   	$(document.body).on('click', '.js-submit-confirm', function (event) {
		...
		var $el = $(this)
		var text = $el.data('confirm-message') ? $el.data('confirm-message') : 
		'Kamu tidak akan bisa membatalkan proses ini!'
		swal({
